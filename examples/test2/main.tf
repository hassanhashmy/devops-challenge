...
locals {
  ...
  public_subnet_id = (var.vpc_id != null && var.public_subnet_id != null ?
    var.public_subnet_id :
    try(module.vpc[0].public_subnets[0])
  )
  private_subnet_id = (var.vpc_id != null && var.private_subnet_id != null ?
    var.private_subnet_id :
    try(module.vpc[0].private_subnets[0])
  )
...
module "provisioner" {
  ...
  proxy_host        = module.ec2_proxy.public_ip
  proxy_private_key = module.key_pair.private_key_openssh
...
module "ec2_proxy" {
  ...
  proxied_server = module.ec2.private_ip
